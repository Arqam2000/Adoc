...
const DocExperience = ({ hospitals, designations, handleOpenModal, handleRows2fromDocExperience, saveExpToDB, handleFocus, docExperience, dr }) => {
  ...
  console.log("docExp from DocExperience", docExperience)

  // console.log("hospitals", hospitals)
  // console.log("designations", designations)

  useEffect(() => {
    setRows2(docExperience || [
      {
        hospital: "",
        designation: "",
        fromDate: "",
    ...
    handleRows2fromDocExperience(docExperience || [
      {
        hospital: "",
        designation: "",
        fromDate: "",
    ...
    if (JSON.parse(localStorage.getItem("rows2"))) {
      // setRows2(JSON.parse(localStorage.getItem("rows2")) || docExperience)
  ...
  console.log("rows2 from docExperience", rows2)
