    ...
    const editInstitute = async (institute_code) => {
        if (!institute_code) {
            ...
            try {
                ...
                let instituteIndex = institutes.findIndex(institute => institute.university == institute_code)
    ...
    const deleteInstitute = async (institute_code) => {
        if (!institute_code) {
            ...
            try {
                ...
                const newInstitutes = institutes.filter(institute => institute.university != institute_code)
                console.log(newInstitutes)
